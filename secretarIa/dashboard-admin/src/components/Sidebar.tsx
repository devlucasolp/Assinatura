...
import { LayoutDashboard, Bot, Settings, Users, FileText, Plug, ChevronDown, X, Moon, Sun, LogOut, Puzzle, Sliders, Box, Eye, Beaker } from 'lucide-react'
...
const NAV: NavItem[] = [
  ...
  { label: 'Teste',        href: '/testes',                icon: Beaker },
  {
    kind: 'group',
    label: 'Configurações',
    icon: Settings,

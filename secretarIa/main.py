...
from routes.dashboard import router as dashboard_router, evolution_router
...
from routes.custom_webhooks import router as custom_webhook_router
from routes.internal_actions import router as internal_actions_router
...
app.mount("/", StaticFiles(directory="dashboard-admin", html=True), name="dashboard")

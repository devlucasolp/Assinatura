...
import { ArrowLeft, Trash2, Save, Settings2, Sparkles, MessageSquare, Puzzle, Zap } from 'lucide-react'
      ...
      <div className="max-w-2xl">
        {tab === 'geral' && (
          <div className="flex flex-col gap-8">
            ...
            <section>
              <h3 className="text-sm font-semibold text-zinc-900 dark:text-white mb-1">WhatsApp</h3>
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mb-4">Números autorizados e instância na Evolution API.</p>
              <div className="grid grid-cols-2 gap-x-6 gap-y-6">
                {F('Telefone principal', 'phone_primary', { placeholder: '5511999999999', required: true })}
                {F('Telefone secundário', 'phone_secondary', { placeholder: '5511988888888 (opcional)' })}
                {F('Nome da instância Evolution', 'evolution_instance', { placeholder: 'gabi-bot', required: true, span: 'full', description: 'Deve coincidir exatamente com o nome cadastrado na Evolution API.' })}
              </div>
            </section>
